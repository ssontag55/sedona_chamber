<?php
  ...
  $serverUrls = array(
    ...
    array( 'url' => 'http://geo.asascience.com',        'matchAll' => true, 'token' => '' ),
    array( 'url' => 'geo.asascience.com',        'matchAll' => true, 'token' => '' ),
    array( 'url' => 'http://google.com',        'matchAll' => false, 'token' => '' )
  );
  /***************************************************************************/
  ...
  $options = array(
    CURLOPT_URL => urldecode($targetUrl),
    ...
    "x-api-key: 7aaef087db105b9329060ee22b1d7014"
    ),
  ...
  header("x-api-key: 7aaef087db105b9329060ee22b1d7014");
